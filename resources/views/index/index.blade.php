...
<head>
    <meta charset="UTF-8">
    <title>{{ $title }}</title>
    <link rel="shortcut icon" href="{{ $index_img }}/favicons/1.png">
    <link rel="stylesheet" href="{{ $index_css }}/reset.css">
...
<header class="header" id="header">
    ...
    <div class="banner">
        <h2 class="banner-titlte"><img src="{{ $index_img }}/banner-title_img.svg" alt="#"></h2>
        <div class="search">
            <form action="#">
                <input type="text" class="search-text" placeholder="搜索你喜欢的">
                <a href="#" class="search-btn sprite_icon"></a>
    ...
    <div class="main-inner">
        <div class="main-list">
            ...
            <div class="main-list__wrapper clearfix">
                <a href="#"><img src="{{ $index_img }}/cont/main-list__img1.jpg" alt="#"><span>SD娃娃</span></a>
                <a href="#"><img src="{{ $index_img }}/cont/main-list__img2.jpg" alt="#"><span>旧物改造</span></a>
                <a href="#"><img src="{{ $index_img }}/cont/main-list__img3.jpg" alt="#"><span>古风海报</span></a>
                <a href="#"><img src="{{ $index_img }}/cont/main-list__img4.jpg" alt="#"><span>简笔画</span></a>
                <a href="#"><img src="{{ $index_img }}/cont/main-list__img5.jpg" alt="#"><span>夜景手机壁纸</span></a>
                <a href="#"><img src="{{ $index_img }}/cont/main-list__img6.jpg" alt="#"><span>杨洋</span></a>
                <a href="#"><img src="{{ $index_img }}/cont/main-list__img7.jpg" alt="#"><span>条纹服饰</span></a>
            </div>
        </div>
        <div class="main-waterfall">
            ...
            <div class="main-waterfall__wrapper">
                <div class="main-waterfall__row clearfix">
                    <div class="waterfall-imgbox waterfall-box"><a href="#"><img src="{{ $index_img }}/cont/waterfall_img1.jpg" alt="#"></a></div>
                    ...
                    <div class="waterfall-imgbox waterfall-box"><a href="#"><img src="{{ $index_img }}/cont/waterfall_img2.jpg" alt="#"></a></div>
                    <div class="waterfall-imgbox waterfall-box">
                        <a href="#"><img src="{{ $index_img }}/cont/waterfall_img3.jpg" alt="#"></a>
                ...
                <div class="main-waterfall__row clearfix">
                    <div class="waterfall-imgbox waterfall-box">
                        <a href="#"><img src="{{ $index_img }}/cont/waterfall_img4.jpg" alt="#"></a>
                        <div class="waterfall-collect">
                            <i class="title"></i>
                            <div class="info">
                                <h4><a href="#">【Gentle.|温存】</a></h4>
                    ...
                    <div class="waterfall-imgbox waterfall-box">
                        <a href="#"><img src="{{ $index_img }}/cont/waterfall_img5.jpg" alt="#"></a>
                    </div>
                    <div class="waterfall-box">
                        <div class="waterfall-info waterfall-info__top">
                            <i class="title"></i>
                    ...
                    <div class="waterfall-imgbox waterfall-box">
                        <a href="#"><img src="{{ $index_img }}/cont/waterfall_img6.png" alt="#"></a>
                    </div>
                </div>
                <div class="main-waterfall__row clearfix">
                    <div class="waterfall-imgbox waterfall-box"><a href="#"><img src="{{ $index_img }}/cont/waterfall_img7.jpg" alt="#"></a></div>
                    <div class="waterfall-box">
                        <div class="waterfall-info waterfall-info__top">
                            <i class="title"></i>
                            <h3><a href="#">乐高蝙蝠侠大电影</a></h3>
                    ...
                    <div class="waterfall-imgbox waterfall-box"><a href="#"><img src="{{ $index_img }}/cont/waterfall_img8.jpg" alt="#"></a></div>
                    <div class="waterfall-imgbox waterfall-box">
                        <a href="#"><img src="{{ $index_img }}/cont/waterfall_img9.jpg" alt="#"></a>
                        <div class="waterfall-collect">
                            <i class="title"></i>
                            <div class="info">
                                <h4><a href="#">【Gentle.|温存】</a></h4>
                ...
                <div class="main-waterfall__row clearfix">
                    <div class="waterfall-imgbox waterfall-box">
                        <a href="#"><img src="{{ $index_img }}/cont/waterfall_img10.jpg" alt="#"></a>
                        <div class="waterfall-collect">
                            <i class="title"></i>
                            <div class="info">
                                <h4><a href="#">【Gentle.|温存】</a></h4>
                    ...
                    <div class="waterfall-imgbox waterfall-box">
                        <a href="#"><img src="{{ $index_img }}/cont/waterfall_img11.jpg" alt="#"></a>
                    </div>
                    <div class="waterfall-box">
                        <div class="waterfall-info waterfall-info__top">
                            <i class="title"></i>
                    ...
                    <div class="waterfall-imgbox waterfall-box">
                        <a href="#"><img src="{{ $index_img }}/cont/waterfall_img12.png" alt="#"></a>
                    </div>
                </div>
                <div class="main-waterfall__row clearfix">
                    <div class="waterfall-imgbox waterfall-box"><a href="#"><img src="{{ $index_img }}/cont/waterfall_img13.jpg" alt="#"></a></div>
                    <div class="waterfall-box">
                        <div class="waterfall-info waterfall-info__top">
                            <i class="title"></i>
                            <h3><a href="#">乐高蝙蝠侠大电影</a></h3>
                    ...
                    <div class="waterfall-imgbox waterfall-box"><a href="#"><img src="{{ $index_img }}/cont/waterfall_img14.png" alt="#"></a></div>
                    <div class="waterfall-imgbox waterfall-box">
                        <a href="#"><img src="{{ $index_img }}/cont/waterfall_img15.jpg" alt="#"></a>
                        <div class="waterfall-collect">
                            <i class="title"></i>
                            <div class="info">
                                <h4><a href="#">【Gentle.|温存】</a></h4>
...
<footer class="footer" id="footer">
    <div class="footer-column__wrapper">
        ...
        <div class="footer-column footer-followus">
            ...
            <a href="#" class="weixin">官方微信：<img src="{{ $index_img }}/footer-weixin.png" alt="#"><img src="{{ $index_img }}/footer_weixin_orcode.png" alt="#" class="orcode"></a>
        </div>
    </div>
...
<div class="user" id="user">
    <div class="user-inner">
        <img src="{{ $index_img }}/login_logo.png" alt="#" class="login-logo">
        <div class="register">
            <div class="holder">
